...
--->
# Azure IoT edge AI vision and audio dev kit datasheet 



|Product Specification           |     |
|--------------------------------|--------|
|Industrial Design               |Integrated 80/20 mounts <br> Detachable carrier board, vision and speech SoMs <br> Can be used at your desk on the box, out of the box, on the wall, in your test lab, or as a proof of concept in your production environment       |
|Performance                     |  |
|Target Industries               |Retail <br> Manufacturing  |
|Hero Scenarios                  |Out-of-box to first AI frames in less than 10 minutes <br> Out-of-box to prototype in under 30 minutes <br> Capture and label initial training data <br> Basic AI model customization <br> Advanced AI model customization |
|Price                           | |
|Included in Box  |1x Carrier Board <br> 1x Azure Ear SoM <br> 1x Azure Eye SoM <br> 1x RGB Sensor <br> 1x USB 3.0 Type A to Micro B Cable <br> 1x USB 3.0 Type C Cable <br> 1x RGB MIPI Camera Cable <br> 1x DC Power Cable <br> 1x AC/DC Converter <br> Carrier Board and SoM Enclosures <br> 2x Wi-Fi Antennas  |
|External Dimensions             |  |
|Weight                          |TBD          |
|OS                              |Linux: CentOS           |
